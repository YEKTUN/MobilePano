...
function TimePropertiesPanel({ selectedPanoId, selectedComponent }) {
  ...
  // If this isn't a "Time" component, show a placeholder
  if (!selectedComponent || selectedComponent.type !== "Time") {
    return (
      <div>
        <h2 className="font-bold mb-2">Properties</h2>
        <p>No **Time** component selected.</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-4 border rounded-md bg-white shadow-md w-[600px]">
      ...
      <select
        name="datePickerType"
        value={formData.datePickerType || "Time"}
        onChange={handleChange}
        className="border rounded px-2 py-1 w-full mb-3"
      >
      ...
      <select
        name="timeFormat"
        value={formData.timeFormat || "HH:mm:ss (12:00:00)"}
        onChange={handleChange}
        className="border rounded px-2 py-1 w-full mb-3"
      >
        <option value="HH:mm:ss (12:00:00)">HH:mm:ss (12:00:00)</option>
        <option value="HH:mm (12:00)">HH:mm (12:00)</option>
...
export default TimePropertiesPanel;
