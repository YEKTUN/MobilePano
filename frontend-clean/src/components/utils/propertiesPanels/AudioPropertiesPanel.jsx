...
function AudioPropertiesPanel({ selectedPanoId, selectedComponent }) {
  ...
  if (!selectedComponent || selectedComponent.type !== "Audio") {
    return (
      <div>
        <h2 className="font-bold mb-2">Properties</h2>
        <p>No **Audio** component selected.</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-4 border rounded-md bg-white shadow-md w-[600px]">
      ...
      <h2 className="text-lg font-bold mb-4">Audio Properties</h2>
