...
function DateTimePropertiesPanel({ selectedPanoId, selectedComponent }) {
  ...
  if (!selectedComponent || selectedComponent.type !== "DateTime") {
    return (
      <div>
        <h2 className="font-bold mb-2">Properties</h2>
        <p>No **DateTime** component selected.</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-4 border rounded-md bg-white shadow-md w-[600px]">
      ...
      <select
        name="datePickerType"
        value={formData.datePickerType || "Date time both"}
        onChange={handleChange}
        className="border rounded px-2 py-1 w-full mb-3"
      >
      ...
      <select
        name="dateTimeFormat"
        value={
          formData.dateTimeFormat || "MM/dd/YYYY HH:mm:ss (02/21/2018 12:00:00)"
        }
        onChange={handleChange}
        className="border rounded px-2 py-1 w-full mb-3"
      >
        <option value="MM/dd/YYYY HH:mm:ss (02/21/2018 12:00:00)">
          MM/dd/YYYY HH:mm:ss (02/21/2018 12:00:00)
        </option>
        <option value="MM/dd/YY HH:mm (02/21/18 12:00)">
          MM/dd/YY HH:mm (02/21/18 12:00)
        </option>
        <option value="dd/MM/YYYY HH:mm:ss (21/02/2018 12:00:00)">
          dd/MM/YYYY HH:mm:ss (21/02/2018 12:00:00)
        </option>
        <option value="dd/MM/YY HH:mm (21/02/18 12:00)">
          dd/MM/YY HH:mm (21/02/18 12:00)
        </option>
      </select>
...
export default DateTimePropertiesPanel;
