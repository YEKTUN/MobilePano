...
function ChildRecordPropertiesPanel({ selectedPanoId, selectedComponent }) {
  ...
  if (!selectedComponent || selectedComponent.type !== "ChildRecord") {
    return (
      <div>
        <h2 className="font-bold mb-2">Properties</h2>
        <p>No **ChildRecord** component selected.</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-4 border rounded-md bg-white shadow-md w-[600px]">
      ...
      <h2 className="text-lg font-bold mb-4">ChildRecord Properties</h2>
      ...
      <div className="flex justify-between items-center mb-3">
        ...
        <Switch
          checked={!!formData.showInlineList}
          onCheckedChange={(checked) => handleSwitchChange("showInlineList", checked)}
        />
      </div>
      ...
      <select
        name="recordLimitType"
        value={formData.recordLimitType || ""}
        onChange={handleChange}
        className="border rounded px-2 py-1 w-full mb-3"
      >
...
export default ChildRecordPropertiesPanel;
